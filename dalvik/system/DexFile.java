...
/**dex文件的路径，可能是/data/dalvik-cache
	1.加载类
...
public final class DexFile {
    private final int mCookie;//mCookie映射到优化过后的dex文件
    private String mFileName;//原始的文件名
    ...
    private DexFile(String sourceName, String outputName, int flags)
        ...
        mCookie = openDexFile(sourceName, outputName, flags);//打开dexFile
     ...
     *
     * @param sourcePathName 包含了classes.dex的jar文件或者apk文件
    ...
    /**枚举这个dex文件里面的类名，包名之间的分隔符是斜杠，而不是.
