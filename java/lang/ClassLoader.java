...
public abstract class ClassLoader {
    ...
    /**android中的系统ClassLoader是PathClassLoader,而在ClassLoader结构中是有父ClassLoader的，PathClassLoader的父ClassLoader字段传入null,
    表示PathClassLoader的父加载器是bootstrap加载器（这个加载器一般都是由C语言编写的）
    ...
    public static ClassLoader getSystemClassLoader() {
        ...
        if (smgr != null) {
            ...
            //调用者的类加载器不为null,并且不是系统类加载器或者系统类加载器的祖先，那么会权限检测
