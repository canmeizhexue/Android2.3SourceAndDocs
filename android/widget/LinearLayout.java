...
public class LinearLayout extends ViewGroup {
    ...
    void layoutVertical() {
        ...
        //mBottom - mTop  - mTotalLength这个值表示这个线性布局除了自己的padding和子view的高度后，剩下的空间高度
        if (majorGravity != Gravity.TOP) {
           switch (majorGravity) {
               case Gravity.BOTTOM:
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child == null) {
                ...
                if (gravity < 0) {
                    //如果这个子节点没设置gravity，那么使用线性布局中默认的gravity
    ...
    /**水平方向上的布局，使用的是子view的测量值，水平方向的线性布局，可以使用baseline属性
     * Position the children during a layout pass if the orientation of this
