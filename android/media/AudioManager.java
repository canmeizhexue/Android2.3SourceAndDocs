...
/**音量和铃声控制，大部分功能是转发给了AudioService
...
public class AudioManager {
    ...
    {
        // 静态变量，是否会有多线程问题，导致有多个sService实例，或者是否不同线程从ServiceManager.getService拿到的都是一样的
        if (sService != null) {
            return sService;
        }
        IBinder b = ServiceManager.getService(Context.AUDIO_SERVICE);

        //这个地方验证下在不同线程甚至在不同进程中获取到的这个Binder是否是一样的
