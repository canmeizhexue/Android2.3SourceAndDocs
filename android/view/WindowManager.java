...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
        ...
        /**主要有三类窗口
         * 1.应用程序窗口，它的token一定是Activity的token
         * 2.子窗口，它的token一定是父窗口的token
         * 3.系统窗口
         ...
         * @see #FLAG_NOT_TOUCH_MODAL //modal模态
        ...
        /** 标识不能接收touch事件，Window flag: this window can never receive touch events. */
         ...
         * 2.如果创建的是子窗口，那么它要和他父窗口token指向同一个W对象
         * 3.如果是系统窗口，那么它为null
